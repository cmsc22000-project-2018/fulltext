...
void check_find_match_matches(char* line, char* word, int pos_start, list_t matches)
{
	int lineNum = 1;
	int result = find_match(line, word, pos_start, lineNum, &matches);
	if (result != -1) {
		...
		match *foundMatch = get_at_index(result, &matches);
...
Test(search, find_one_existent_match)
{
	...
	list_t matches1;
	list_init(&matches1);
	check_find_match_pos(line1, word1, 0, matches1, 6);
	check_find_match_matches(line1, word1, 0, matches1);
}
...
Test(search, find_one_existent_match_first)
{
	...
	list_t matches3;
	list_init(&matches3);
	check_find_match_pos(line3, word3, 0, matches3, 1);
	check_find_match_matches(line3, word3, 0, matches3);
}
...
Test(search, find_one_existent_match_last)
{
	...
	list_t matches2;
	list_init(&matches2);
	check_find_match_pos(line2, word2, 0, matches2, 10);
	check_find_match_matches(line2, word2, 0, matches2);
}
...
Test(search, find_two_existent_matches)
{
	...
	list_t matches1;
	list_init(&matches1);
	check_find_match_pos(line1, word1, 0, matches1, 8);
	check_find_match_matches(line1, word1, 0, matches1);
	check_find_match_pos(line1, word1, 8, matches1, 10);
	check_find_match_matches(line1, word1, 8, matches1);
}
...
Test(search, find_two_existent_matches_first_last)
{
	...
	check_find_match_matches(line1, word1, 0, matches1);
	check_find_match_pos(line1, word1, 1, matches1, 10);
	check_find_match_matches(line1, word1, 1, matches1);
}
...
Test(search, find_mult_existent_matches)
{
	...
	check_find_match_pos(line1, word1, 0, matches1, 1);
	check_find_match_matches(line1, word1, 0, matches1);
	check_find_match_pos(line1, word1, 1, matches1, 4);
	check_find_match_matches(line1, word1, 1, matches1);
	check_find_match_pos(line1, word1, 4, matches1, 5);
	check_find_match_matches(line1, word1, 4, matches1);
	check_find_match_pos(line1, word1, 5, matches1, 7);
	check_find_match_matches(line1, word1, 5, matches1);
}
